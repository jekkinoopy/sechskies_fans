...
<body class="auth-page"><main class="auth-card"><a class="auth-brand" href="../crystal-dance-survey.html" aria-label="返回 sechskies_fans 前台"><span>sechskies_fans</span><span>CONTENT MANAGEMENT SYSTEM</span></a><p class="eyebrow">SECHSKIES DANCE ARCHIVE</p><h1>水晶熱舞社管理登入</h1><p>練舞清單與 30TH 應援報名，獨立管理。</p><?php if (isset($_GET['setup'])): ?><div class="notice notice--success">管理者建立完成，請登入。</div><?php endif; ?><?php if ($error): ?><div class="notice notice--error"><?= h($error) ?></div><?php endif; ?>
