...
<body class="auth-page"><main class="auth-card"><a class="auth-brand" href="../practice-room.html" aria-label="返回 sechskies_fans 前台"><span>sechskies_fans</span><span>CONTENT MANAGEMENT SYSTEM</span></a><p class="eyebrow">小黃同樂會・SECHSKIES FANS ARCHIVE</p><h1>水晶男孩推廣部後臺管理</h1><p>練舞清單、小黃集點卡與 30TH 應援報名，統一管理。</p><?php if (isset($_GET['setup'])): ?><div class="notice notice--success">管理者建立完成，請登入。</div><?php endif; ?><?php if ($error): ?><div class="notice notice--error"><?= h($error) ?></div><?php endif; ?>
