...
<body class="auth-page"><main class="auth-card"><a class="auth-brand" href="../practice-room.html" aria-label="返回 YELLOW WAVE 前台"><span>YELLOW WAVE</span></a><h1>建立第一位管理者</h1><?php if ($error): ?><div class="notice notice--error"><?= h($error) ?></div><?php endif; ?>
