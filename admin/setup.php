...
<body class="auth-page"><main class="auth-card"><a class="auth-brand" href="../jekki-dance.html" aria-label="返回 sechskies_fans 前台"><span>sechskies_fans</span><span>CONTENT MANAGEMENT SYSTEM</span></a><p class="eyebrow">FIRST-TIME SETUP</p><h1>建立第一位管理者</h1><p>sechskies_fans 內容管理系統</p><?php if ($error): ?><div class="notice notice--error"><?= h($error) ?></div><?php endif; ?>
